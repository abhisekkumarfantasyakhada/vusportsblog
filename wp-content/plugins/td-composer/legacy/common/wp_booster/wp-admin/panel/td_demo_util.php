...
class td_demo_tax extends td_demo_base {
    ...
    static function add_taxonomy( $params_array ) {
	    ...
	    $td_stacks_td_demo_taxonomies_ids = get_option( 'td_demo_taxonomies_terms_ids' );
	    $td_stacks_td_demo_taxonomies_ids[$params_array['taxonomy']]= $new_tax_term_id;
        update_option('td_demo_taxonomies_ids', $td_stacks_td_demo_taxonomies_ids );
    ...
    static function remove() {
        ...
        if ( is_array( $td_stacks_td_demo_taxonomies_terms_ids ) ) {
            foreach ( $td_stacks_td_demo_taxonomies_terms_ids as $tax => $tax_term_id ) {
