    ...
    function render($atts, $content = null) {
	    ...
	    if ( false === $td_author ) {
		    ...
		    $buffy .= '<div class="' . $this->get_block_classes() . '" ' . $this->get_block_html_atts() . '>';
			    $buffy .= '<div class="td_author_wrap td-fix-index">';
				    $buffy .= '<a href="#" aria-label="author-photo">' . get_avatar('', '196') . '</a>';
        ...
        $buffy .= '<div class="' . $this->get_block_classes() . '" ' . $this->get_block_html_atts() . '>';
            ...
            $buffy .= '<div class="td_author_wrap td-fix-index td-pb-padding-side">';
                $buffy .= '<a href="' . get_author_posts_url($td_author->ID) . '" aria-label="author-photo">' . get_avatar($td_author->user_email, '196') . '</a>';
                $buffy .= '<div class="item-details">';
