...
addFilterTypeHeader:function(a,c){c='<div class="tdc-filter-header '+tdcSidebarPanel._getParameterClasses(a)+'">';c+='<span class="tdc-filter-header-name">'+a.heading+"</span>";return c+'<span class="tdc-filter-header-type" title="Select the type of attribute">Type</span></div>'},addFilterTitle:function(a,c){var b="",e="",d="";_.has(a,"info_img")&&""!==a.info_img&&(e='data-info-img="'+a.info_img+'"',_.has(a,"description")&&""!==a.description&&(d='data-info-descr="'+a.description+'"'));var f="";_.has(a,
"toggle_enable_params")&&""!==a.toggle_enable_params&&(f='data-enable-params="'+a.toggle_enable_params+'"');var g="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var l="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(l='data-enabled-by="'+a.toggle_enabled_by+'"');return b+='<div class="tdc-sidebar-filter-title '+tdcSidebarPanel._getParameterClasses(a)+'" '+e+" "+d+" "+f+" "+g+" "+l+'><span class="tdc-search-data">'+tdcSidebarPanel._getParameterCurrentValue(a,
c)+"</span></div>"},addClearfix:function(a,c){return'<div class="clearfix"></div>'},updateTextfieldResponsiveValues:function(a,c,b){"undefined"===typeof window.tdcResponsiveValues[a]?""!==c&&(window.tdcResponsiveValues[a]={},window.tdcResponsiveValues[a][b]={viewportName:c}):""===c?delete window.tdcResponsiveValues[a][b]:window.tdcResponsiveValues[a][b]=c;c=_.allKeys(window.tdcResponsiveValues[a]);return 1===c.length&&"all"===c[0]?window.tdcResponsiveValues[a].all:1<c.length||1===c.length&&"all"!==
